...
def solve(obj, perfLB, areaUB, powerUB, costUB, calibrate_theta_ca):
...
if __name__ == "__main__":
    ...
    load_data()
    results, calibrated_theta_ca = solve(args.obj, args.perfLB, args.areaUB, args.powerUB, args.costUB, args.theta_ca)
